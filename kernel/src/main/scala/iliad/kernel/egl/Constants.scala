...
object Constants {
  ...
  case object EGL_BAD_ALLOC                     extends IntConstant(0x3003)
  case object EGL_BAD_ATTRIBUTE                 extends IntConstant(0x3004)
  case object EGL_BAD_CONFIG                    extends IntConstant(0x3005)
  case object EGL_BAD_CONTEXT                   extends IntConstant(0x3006)
  ...
  case object EGL_BAD_MATCH                     extends IntConstant(0x3009)
  case object EGL_BAD_NATIVE_PIXMAP             extends IntConstant(0x300A)
  case object EGL_BAD_NATIVE_WINDOW             extends IntConstant(0x300B)
  case object EGL_BAD_PARAMETER                 extends IntConstant(0x300C)
  case object EGL_BAD_SURFACE                   extends IntConstant(0x300D)
  case object EGL_BLUE_SIZE                     extends IntConstant(0x3022) with ConfigAttrib
  case object EGL_BUFFER_SIZE                   extends IntConstant(0x3020) with ConfigAttrib
  case object EGL_CONFIG_CAVEAT                 extends IntConstant(0x3027) with ConfigAttrib
  case object EGL_CONFIG_ID                     extends IntConstant(0x3028) with ConfigAttrib
  case object EGL_CORE_NATIVE_ENGINE            extends IntConstant(0x305B)
  case object EGL_DEPTH_SIZE                    extends IntConstant(0x3025) with ConfigAttrib
  ...
  case object EGL_MAX_PBUFFER_PIXELS            extends IntConstant(0x302B)
  case object EGL_MAX_PBUFFER_WIDTH             extends IntConstant(0x302C)
  case object EGL_NATIVE_RENDERABLE             extends IntConstant(0x302D) with ConfigAttrib
  ...
  case object EGL_SAMPLES                       extends IntConstant(0x3031) with ConfigAttrib
  case object EGL_SAMPLE_BUFFERS                extends IntConstant(0x3032) with ConfigAttrib
  case object EGL_SLOW_CONFIG                   extends IntConstant(0x3050) with ConfigAttribValue
  case object EGL_STENCIL_SIZE                  extends IntConstant(0x3026) with ConfigAttrib
  ...
  case object EGL_TRANSPARENT_BLUE_VALUE        extends IntConstant(0x3035) with ConfigAttrib
  case object EGL_TRANSPARENT_GREEN_VALUE       extends IntConstant(0x3036) with ConfigAttrib
  case object EGL_TRANSPARENT_RED_VALUE         extends IntConstant(0x3037) with ConfigAttrib
  case object EGL_TRANSPARENT_RGB               extends IntConstant(0x3052) with ConfigAttribValue
  case object EGL_TRANSPARENT_TYPE              extends IntConstant(0x3034) with ConfigAttrib
  ...
  case object EGL_BIND_TO_TEXTURE_RGB           extends IntConstant(0x3039) with ConfigAttrib
  case object EGL_BIND_TO_TEXTURE_RGBA          extends IntConstant(0x303A) with ConfigAttrib
  case object EGL_CONTEXT_LOST                  extends IntConstant(0x300E)
  case object EGL_MIN_SWAP_INTERVAL             extends IntConstant(0x303B) with ConfigAttrib
  case object EGL_MAX_SWAP_INTERVAL             extends IntConstant(0x303C) with ConfigAttrib
  ...
  case object EGL_ALPHA_MASK_SIZE               extends IntConstant(0x303E) with ConfigAttrib
  case object EGL_BUFFER_PRESERVED              extends IntConstant(0x3094)
  case object EGL_BUFFER_DESTROYED              extends IntConstant(0x3095)
  case object EGL_CLIENT_APIS                   extends IntConstant(0x308D)
  ...
  case object EGL_COLOR_BUFFER_TYPE             extends IntConstant(0x303F) with ConfigAttrib
  ...
  case object EGL_LUMINANCE_SIZE                extends IntConstant(0x303D) with ConfigAttrib
  ...
  case object EGL_RENDERABLE_TYPE               extends IntConstant(0x3040) with ConfigAttrib
  ...
  /** EGL 13 */
  case object EGL_CONFORMANT                    extends IntConstant(0x3042) with ConfigAttrib
  case object EGL_CONTEXT_CLIENT_VERSION        extends IntConstant(0x3098) with ContextAttrib
  case object EGL_MATCH_NATIVE_PIXMAP           extends IntConstant(0x3041) with ConfigAttrib
