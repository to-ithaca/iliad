...
case object EGL_CONFIG_CAVEAT extends IntConstant(0x3027) with ConfigAttrib with EnumConfigAttrib
case object EGL_CONFIG_ID extends IntConstant(0x3028) with ConfigAttrib with IntConfigAttrib
case object EGL_CORE_NATIVE_ENGINE extends IntConstant(0x305B)
case object EGL_DEPTH_SIZE extends IntConstant(0x3025) with ConfigAttrib with IntConfigAttrib
...
case object EGL_GREEN_SIZE extends IntConstant(0x3023) with ConfigAttrib with IntConfigAttrib
...
case object EGL_LEVEL extends IntConstant(0x3029) with ConfigAttrib with IntConfigAttrib
case object EGL_MAX_PBUFFER_HEIGHT extends IntConstant(0x302A) with IntConfigAttrib
case object EGL_MAX_PBUFFER_PIXELS extends IntConstant(0x302B) with IntConfigAttrib
case object EGL_MAX_PBUFFER_WIDTH extends IntConstant(0x302C) with IntConfigAttrib
case object EGL_NATIVE_RENDERABLE extends IntConstant(0x302D) with ConfigAttrib with EnumConfigAttrib
...
case object EGL_RED_SIZE extends IntConstant(0x3024) with ConfigAttrib with IntConfigAttrib
case object EGL_SAMPLES extends IntConstant(0x3031) with ConfigAttrib with IntConfigAttrib
case object EGL_SAMPLE_BUFFERS extends IntConstant(0x3032) with ConfigAttrib with IntConfigAttrib
case object EGL_SLOW_CONFIG extends IntConstant(0x3050) with ConfigAttribValue
case object EGL_STENCIL_SIZE extends IntConstant(0x3026) with ConfigAttrib with IntConfigAttrib
...
case object EGL_TRANSPARENT_BLUE_VALUE extends IntConstant(0x3035) with ConfigAttrib with IntConfigAttrib
case object EGL_TRANSPARENT_GREEN_VALUE extends IntConstant(0x3036) with ConfigAttrib with IntConfigAttrib
case object EGL_TRANSPARENT_RED_VALUE extends IntConstant(0x3037) with ConfigAttrib with IntConfigAttrib
case object EGL_TRANSPARENT_RGB extends IntConstant(0x3052) with ConfigAttribValue
case object EGL_TRANSPARENT_TYPE extends IntConstant(0x3034) with ConfigAttrib with EnumConfigAttrib
case object EGL_TRUE extends IntConstant(1) with ConfigAttribValue
case object EGL_VENDOR extends IntConstant(0x3053) with QueryKey
case object EGL_VERSION extends IntConstant(0x3054) with QueryKey
...
case object EGL_BIND_TO_TEXTURE_RGB extends IntConstant(0x3039) with ConfigAttrib with EnumConfigAttrib
case object EGL_BIND_TO_TEXTURE_RGBA extends IntConstant(0x303A) with ConfigAttrib with EnumConfigAttrib
case object EGL_CONTEXT_LOST extends IntConstant(0x300E)
case object EGL_MIN_SWAP_INTERVAL extends IntConstant(0x303B) with ConfigAttrib with IntConfigAttrib
case object EGL_MAX_SWAP_INTERVAL extends IntConstant(0x303C) with ConfigAttrib with IntConfigAttrib
...
case object EGL_ALPHA_MASK_SIZE extends IntConstant(0x303E) with ConfigAttrib with IntConfigAttrib
case object EGL_BUFFER_PRESERVED extends IntConstant(0x3094)
case object EGL_BUFFER_DESTROYED extends IntConstant(0x3095)
case object EGL_CLIENT_APIS extends IntConstant(0x308D) with QueryKey
...
case object EGL_COLOR_BUFFER_TYPE extends IntConstant(0x303F) with ConfigAttrib with EnumConfigAttrib
...
case object EGL_LUMINANCE_BUFFER extends IntConstant(0x308F) with ConfigAttribValue
case object EGL_LUMINANCE_SIZE extends IntConstant(0x303D) with ConfigAttrib with IntConfigAttrib
case object EGL_OPENGL_ES_BIT extends IntConstant(0x0001)
case object EGL_OPENVG_BIT extends IntConstant(0x0002)
case object EGL_OPENGL_ES_API extends IntConstant(0x30A0) with API
case object EGL_OPENVG_API extends IntConstant(0x30A1) with API
...
case object EGL_CONTEXT_CLIENT_VERSION extends IntConstant(0x3098) with ContextAttrib //CHECK
case object EGL_MATCH_NATIVE_PIXMAP extends IntConstant(0x3041) with ConfigAttrib //CHECK
...
/** EGL 14 */
case object EGL_DEFAULT_DISPLAY extends IntConstant(0)
...
case object EGL_OPENGL_API extends IntConstant(0x30A2) with API
...
case object EGL_CONTEXT_OPENGL_RESET_NOTIFICATION_STRATEGY extends IntConstant(0x31BD)
...
case object EGL_CONTEXT_OPENGL_COMPATIBILITY_PROFILE_BIT extends IntConstant(0x00000002)
