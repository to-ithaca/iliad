...
object Load {
  ...
  def newBuffer(v: Model.VertexData, pageSize: Int, b: VertexBuffer.Base): DSL[VertexBuffer.Loaded] =
    LoadNewVertexBuffer(v, pageSize, b).free
  def newBuffer(
      e: Model.ElementData, pageSize: Int, b: VertexBuffer.Base): DSL[ElementBuffer.Loaded] =
...
case class LoadNewVertexBuffer(v: Model.VertexData, pageSize: Int, b: VertexBuffer.Base)
    extends Load[VertexBuffer.Loaded]
case class LoadNewElementBuffer(e: Model.ElementData, pageSize: Int, b: VertexBuffer.Base)
